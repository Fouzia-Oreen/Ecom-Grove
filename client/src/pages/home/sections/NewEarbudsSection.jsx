      ...
      <div className="container ">
          <div className="grid gap-6 md:grid-cols-2 lg:mx-12 items-center lg:gap-40">
              <div>
                  ...
                  <h4 className="mb-2 text-xl text-color_6">
                      <strong className='text-color_2'>Brand: </strong>Havit
                  </h4>
                  <p className="text-gray-400 text-lg mt-4">
                      These headphones are not only amazing for the design and features, but also for the audio quality. 
                      They are comfortable and lightweight for hours.
                  </p>
                  <p className="text-gray-400 text-lg mt-4">
                      These headphones are not only amazing for the design and features, but also for the audio quality. 
                      They are comfortable and lightweight for hours.
                  ...
                  <div className="flex gap-6 mt-8">
                      <Link to='/shop' className="btn ctg_btn"> View More </Link>
                  </div>
              </div>

              <div className="max-w-lg rounded-md">
                  <Carousel>
                      {newEarbuds.map((slide, index) => (
                      <img key={slide.id}
                        src={slide}
                          alt={""}
                          className="rounded "
